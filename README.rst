...
A wB2B Web applicaton that facilitates business transactions between buyers and suppliers of petroleum products in the downstream oil and gas industry
...
.. code-block:: bash
    ...
    cd tenkobo
    celery -A tenkobo.taskapp worker -l info
